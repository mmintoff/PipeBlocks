...
//        Assert.Equal("MM.PipeBlocks.FuncBlock`2[MM.PipeBlocks.Test.MyContext,MM.PipeBlocks.Test.MyValue] (Method: MM.PipeBlocks.Test.FuncBlockTests+<>c__DisplayClass0_0.<Execute_WithSimpleAction_ExecutesAction>g__simpleAction|0)", actionBlock.ToString());
//    }
...
//        Assert.True(actionExecuted);
//        Assert.Same(context, result);
//        Assert.Equal("MM.PipeBlocks.FuncBlock`2[MM.PipeBlocks.Test.MyContext,MM.PipeBlocks.Test.MyValue] (Method: MM.PipeBlocks.Test.FuncBlockTests+<>c__DisplayClass1_0.<Execute_WithValueAction_ExecutesAction>g__valueAction|0)", actionBlock.ToString());
//    }
...
//                Assert.True(actionExecuted);
//                Assert.Equal("MM.PipeBlocks.FuncBlock`2[MM.PipeBlocks.Test.MyContext,MM.PipeBlocks.Test.MyValue] (Method: MM.PipeBlocks.Test.FuncBlockTests+<>c__DisplayClass2_0.<Execute_WithValueAction_ReturnsFailureContext>g__valueAction|0)", actionBlock.ToString());
//            },
...
//                Assert.Equal("MM.PipeBlocks.FuncBlock`2[MM.PipeBlocks.Test.MyContext,MM.PipeBlocks.Test.MyValue] (Method: MM.PipeBlocks.Test.FuncBlockTests+<>c__DisplayClass3_0.<Execute_WithFailContext>g__valueAction|0)", actionBlock.ToString());
//            },
//            _ => Assert.Fail("Expected a failure"));
//    }
...
//        Assert.True(actionExecuted);
//        Assert.Same(context, result);
//        Assert.Equal("MM.PipeBlocks.AsyncFuncBlock`2[MM.PipeBlocks.Test.MyContext,MM.PipeBlocks.Test.MyValue] (Method: MM.PipeBlocks.Test.FuncBlockTests+<>c__DisplayClass4_0.<Execute_WithSimpleAction_ExecutesAction_Async>g__simpleAction|0)", actionBlock.ToString());
//    }
...
//        Assert.True(actionExecuted);
//        Assert.Same(context, result);
//        Assert.Equal("MM.PipeBlocks.AsyncFuncBlock`2[MM.PipeBlocks.Test.MyContext,MM.PipeBlocks.Test.MyValue] (Method: MM.PipeBlocks.Test.FuncBlockTests+<>c__DisplayClass5_0.<Execute_WithValueAction_ExecutesAction_Async>g__valueAction|0)", actionBlock.ToString());
//    }
...
//                Assert.Equal("Intentional", f.FailureReason);
//                Assert.True(actionExecuted);
//                Assert.Equal("MM.PipeBlocks.AsyncFuncBlock`2[MM.PipeBlocks.Test.MyContext,MM.PipeBlocks.Test.MyValue] (Method: MM.PipeBlocks.Test.FuncBlockTests+<>c__DisplayClass6_0.<Execute_WithValueAction_ReturnsFailureContext_Async>g__valueAction|0)", actionBlock.ToString());
//            },
//            _ => Assert.Fail("Expected a failure"));
//    }
...
//                Assert.False(actionExecuted);
//                Assert.Equal("MM.PipeBlocks.AsyncFuncBlock`2[MM.PipeBlocks.Test.MyContext,MM.PipeBlocks.Test.MyValue] (Method: MM.PipeBlocks.Test.FuncBlockTests+<>c__DisplayClass7_0.<Execute_WithFailContext_Async>g__valueAction|0)", actionBlock.ToString());
//            },
...
//        Assert.Equal("MM.PipeBlocks.FuncBlock`2[MM.PipeBlocks.Test.MyContext,MM.PipeBlocks.Test.MyValue] (Method: MM.PipeBlocks.Test.FuncBlockTests.<Execute_WithSimpleFunction_ReturnsModifiedContext>g__simpleFunc|8_0)", funcBlock.ToString());
//    }
...
//                Assert.Equal("MM.PipeBlocks.FuncBlock`2[MM.PipeBlocks.Test.MyContext,MM.PipeBlocks.Test.MyValue] (Method: MM.PipeBlocks.Test.FuncBlockTests.<Execute_WithSimpleFunction_ReturnsFailureContext>g__simpleFunc|9_0)", funcBlock.ToString());
//            },
//            x => Assert.Fail("Expected a failure"));
//    }
...
//        // Assert
//        Assert.NotSame(context, result);
//        Assert.Equal("MM.PipeBlocks.FuncBlock`2[MM.PipeBlocks.Test.MyContext,MM.PipeBlocks.Test.MyValue] (Method: MM.PipeBlocks.Test.FuncBlockTests.<Execute_WithValueFunction_ReturnsModifiedContext>g__valueFunc|10_0)", funcBlock.ToString());
//    }
...
//                Assert.Equal(context.CorrelationId, x.CorrelationId);
//                Assert.Equal("Intentional", x.FailureReason);
//                Assert.Equal("MM.PipeBlocks.FuncBlock`2[MM.PipeBlocks.Test.MyContext,MM.PipeBlocks.Test.MyValue] (Method: MM.PipeBlocks.Test.FuncBlockTests.<Execute_WithValueFunction_ReturnsFailedContext>g__valueFunc|11_0)", funcBlock.ToString());
//            },
//            x => Assert.Fail("Expected a failure"));
//    }
...
//        // Assert
//        Assert.Same(context, result);
//        Assert.Equal("MM.PipeBlocks.FuncBlock`2[MM.PipeBlocks.Test.MyContext,MM.PipeBlocks.Test.MyValue] (Method: MM.PipeBlocks.Test.FuncBlockTests.<Execute_WithSimpleFunction_ReturnsSameContext>g__simpleFunc|12_0)", funcBlock.ToString());
//    }
...
//        // Assert
//        Assert.Same(context, result);
//        Assert.Equal("MM.PipeBlocks.FuncBlock`2[MM.PipeBlocks.Test.MyContext,MM.PipeBlocks.Test.MyValue] (Method: MM.PipeBlocks.Test.FuncBlockTests.<Execute_WithValueFunction_ReturnsSameContext>g__valueFunc|13_0)", funcBlock.ToString());
//    }
